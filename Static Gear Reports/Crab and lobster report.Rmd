...
cl_ref = data.frame('Date' = as.POSIXct(all_ref$Date, format = '%d/%m/%Y', tz = 'UTC'),
                    'lp_hauled' = all_ref$lp_hauled,
                    'hg_retained' = all_ref$hg_retained,
                    'cp_retained' = all_ref$cp_retained)
